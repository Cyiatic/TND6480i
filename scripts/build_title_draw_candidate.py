...
def main():
    ...
    parser.add_argument("--out-rom", type=Path, default=Path("artifacts/generated/g1castk1.z64"))
    parser.add_argument("--report", type=Path, default=Path("reports/tnd480i_g1castk1_title_draw_20260518.json"))
    ...
    report = {
        ...
        "purpose": (
            "Narrow title/gunbarrel draw-target probe on top of g1castz1. "
            "This applies the full K_title_draw_ge480_target_asset640_height430 word family "
            "without changing gameplay, dossier tables, or the already-promoted cast z-buffer fix."
        ),
        "patches": applied,
