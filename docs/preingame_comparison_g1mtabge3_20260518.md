...
| Opening credits | GE480i credit scale and stock TND credit placement | Likely fails. User observed character credit text running offscreen, and the current capture still needs text-bound measurement. | Later safe-area/scale pass. |
