...
- 2026-05-11 playability reset:
  ...
  - Clean handoff ROM names:
    ...
    - First dossier/classification usability probe: `artifacts/generated/game_h460_top10_stock_dossier_tables_current.z64` (`MD5 f8d146a4a9edd57a2dd2169a4aa9bd21`, `N64 CRC 84B7F86D A3B63A65`). This is built on `game_h460_top10_current.z64` and reverts only the two compressed front/menu display table ranges (`0x9C3C-0x9D24`, `0xA240-0xA264`) to stock TND values. It leaves the gameplay crop, direct front 480i words, watch/pause/HUD text work, and rejected mission-select text offsets untouched. Test this before the broader front-dimension revert.
    - Fallback dossier/classification probe if table-only is still offscreen: `artifacts/generated/game_h460_top10_stock_front_dossier_current.z64` (`MD5 b712eee26aca645d225b7cbf3d449cc3`, `N64 CRC 84B7F529 15121F51`). This also restores direct front/menu sizing words at `0x4DAE0`, `0x4DAE8`, `0x4DAEC`, `0x4DAF4`, `0x106ED4`, `0x106EE4`, `0x106EF0`, `0x106F10`, and `0x106F24` to stock. Treat it as a fallback because it changes more of the front/menu path.
